...
#else
    *fpecipher = "856744916475745705487843618766336986807673508956740048884",
#endif
...
int main()
{
    uint8_t key[64], authKey[32], iv[16], input[BuffL - 16], test[BuffL], output[BuffL],
    ...
    AES_Cipher(authKey, 'D', a + 16, output + 48);
    ...
    *output ^= AES_EAX_decrypt(authKey, test, key, st, sa, output);
#else
