...
static const char
    ...
    *fpe_plain = "012345678901234567890123456789012345678901234567890123456",
#if FF_X == 3                             /*  <---- MAXLEN=56 if R=10 */
    *fpecipher = "8139391240178266727508116864678680319119287273874498520",
#else
    *fpecipher = "175756506480690660973963706347581319894408933022276712315",
#endif
