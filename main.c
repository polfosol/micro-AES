...
static const char
    ...
    *fpe_plain = "123456789098765432101234567890987654321012345678909876543",
#if FF_X == 3                             /*  <---- MAXLEN=56 if R=10 */
    *fpecipher = "5421145092715806545133201636399569532248643844340221640",
#else
    *fpecipher = "290667452633278563466622611103494899335314966650835020553",
#endif
