...
#define PRESET_COUNTER  0  /* enable this macro if CTR_IV_LENGTH == 16        */
...
#endif
#if GCM_SIV
    GCMSIV_NONCE_LEN = 12, /* the only valid value recommended by RFC-8452    */
    GCMSIV_TAG_LEN   = 16, /* the only valid value recommended by RFC-8452    */
#endif
#if OCB
    ...
    EAX_TAG_LEN      = 16, /* again, please see the bottom of this document!  */
#endif
