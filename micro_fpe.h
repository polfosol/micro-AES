...
/**
 * These constants depend on the alphabet and must be determined. You can either
 * pre-calculate the value of logarithm (up to 14 decimal places to be safe) and
 * set it as a constant, or use the standard math library as follows.
 */
#include <math.h>
